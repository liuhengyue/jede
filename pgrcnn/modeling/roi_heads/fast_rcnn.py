...
def fast_rcnn_inference(
    ...
    Returns:
        instances: (list[Players]): A list of N instances, one for each image in the batch,
...
class FastRCNNOutputLayers(nn.Module):
    ...
    def losses(self, predictions, proposals):
        ...
        Args:
            ...
            proposals (list[Players]): proposals that match the features that were used
    ...
    def inference(self, predictions: Tuple[torch.Tensor, torch.Tensor], proposals: List[Players]):
        ...
        Args:
            predictions: return values of :meth:`forward()`.
            proposals (list[Players]): proposals that match the features that were
                used to compute predictions. The ``proposal_boxes`` field is expected.

        Returns:
            list[Players]: same as `fast_rcnn_inference`.
