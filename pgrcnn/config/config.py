...
def add_poseguide_config(cfg):
    ...
    _C.MODEL.ROI_NUMBER_BOX_HEAD.NUM_FC = 2
    # Hidden layer dimension for FC layers in the RoI box head
    ...
    _C.MODEL.ROI_NECK_BASE_BRANCHES.PERSON_BRANCH.UP_SCALE = 2
    ...
    _C.MODEL.ROI_NECK_BASE_BRANCHES.KEYPOINTS_BRANCH.UP_SCALE = 2
