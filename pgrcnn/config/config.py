...
def add_poseguide_config(cfg):
    ...
    _C.MODEL.ROI_DIGIT_NECK.OUTPUT_HEAD_WEIGHTS = (1.0, 1.0, 1.0)
    ...
    # per person roi
    _C.MODEL.ROI_DIGIT_NECK.FG_RATIO = 0.5
    ...
    _C.MODEL.ROI_DIGIT_NECK_BRANCHES.KEYPOINTS_BRANCH.DECONV_KERNEL = 4
